  ...
  render() {
    return (
      <>
        ...
        <p>
          <a href="#" className="btn btn-default btn-lg" role="button">
            More info
          </a>
        </p>
        <div className="btn-group btn-lg">
          <button
            ...
            name="sup"
          >
            <span className="glyphicon glyphicon-bitcoin" />BitcoinBtn
            <span className="glyphicon glyphicon-bitcoin" />
          </button>
          <input type="button" className="btn btn-info" value="button" />
        </div>
